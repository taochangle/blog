				...
				<table class="table table-hover">
					<tbody>
						...
						<?php if(is_array($list)): foreach($list as $key=>$k): ?><tr>
							<td><?php echo ($k["aid"]); ?></td>
							<td><?php echo ($k["atitle"]); ?></td>
							<td><?php echo (date('Y-m-d',$k["atime"])); ?></td>
							<td><span class="label label-success"></span></td>
							<td><?php echo ($k["cname"]); ?></td>
							<td><?php echo (mb_substr($k["acontent"],0,50,'utf-8')); ?></td>
							<td><a data-toggle="modal" data-target="#myModal<?php echo ($k["aid"]); ?>"
								href="#">删除</a>| <a href="#" onclick="edit(<?php echo ($k["aid"]); ?>)">编辑</a></td>
						</tr>
						<div class="modal" id="myModal<?php echo ($k["aid"]); ?>">
								...
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4 class="modal-title">
											你确定要删除文章 《<b><?php echo ($k["atitle"]); ?></b>》 吗？
										</h4>
									</div>
									<div class="modal-body">
										<p><?php echo (mb_substr($k["acontent"],0,100,'utf-8')); ?></p>
									</div>
									<div class="modal-footer">
										<button type="button" class="btn btn-default pull-left"
											data-dismiss="modal">取消</button>
										<button type="button" class="btn btn-danger"
											onclick="del(<?php echo ($k["aid"]); ?>)">确定删除</button>
									</div>
								</div>
							</div>
...
<script>
		...
		function edit(id){
			location.href = '<?php echo U("edit")?>?id='+id;
		}
	</script>
 </section>
    <!-- /.content -->
