...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <!-- Info boxes -->
<link href="/Public/Admin/fileinput/css/fileinput.css" media="all"
	rel="stylesheet" type="text/css" />
<script src="/Public/Admin/fileinput/js/plugins/purify.min.js"></script>
<script src="/Public/Admin/fileinput/js/all-krajee.js"></script>
<script src="/Public/Admin/fileinput/js/plugins/sortable.min.js"></script>
<script src="/Public/Admin/fileinput/js/fileinput.min.js"></script>
<script src="/Public/Admin/fileinput/js/locales/zh.js"
	type="text/javascript"></script>
<script src="/Public/Admin/bootstrap/js/bootstrap.min.js"
	type="text/javascript"></script>
<div class="row">
	<div class="col-md-8">
		<div class="box box-info">
			...
			<!-- /.box-header -->
			<!-- form start -->
			<form class="form-horizontal" action="<?php echo U('User/doChangePassword');?>"
				method='post'>
				<div class="box-body">
					<div class="file-input file-input-ajax-new">
						<div class="file-preview ">
							...
							<div class=" file-drop-zone">
								<div class="file-drop-zone-title">Drag &amp; drop files
									here …</div>
						...
						<div class="input-group file-caption-main">
							...
							<div class="input-group-btn">
								...
								<a href="/file-upload-batch/2" tabindex="500"
									title="Upload selected files"
									class="btn btn-default fileinput-upload fileinput-upload-button"><i
									class="glyphicon glyphicon-upload"></i> <span class="hidden-xs">Upload</span></a>
								<div tabindex="500" class="btn btn-primary btn-file">
									<i class="glyphicon glyphicon-folder-open"></i>&nbsp; <span
										class="hidden-xs">Browse …</span><input id="input-44"
										name="input44[]" type="file" multiple="" class="">
								</div>
							</div>
						</div>
					</div>
