...
<div class="row">
	<div class="col-md-8">
		<div class="box box-info">
			...
			<!-- /.box-header -->
			<!-- form start -->
			<form class="form-horizontal" method="post" action="<?php echo U('Article/doEdit');?>">
				<div class="box-body">
					<div class="form-group">
						<label for="inputEmail3" class="col-sm-2 control-label">文章标题</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="inputEmail3"
								placeholder="文章标题" name='atitle'  value="<?php echo ($artData["atitle"]); ?>">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<?php if(is_array($catData)): foreach($catData as $key=>$v): ?><option value="<?php echo ($v["cid"]); ?>" <?php if($v['cid']==$artData['acid']){ echo "selected";} ?> ><?php echo ($v["cname"]); ?></option><?php endforeach; endif; ?>
							</select>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="inputPassword3"
								placeholder="文章排序" name='aorder' value="<?php echo ($artData["aorder"]); ?>">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<textarea name='acontent' class="form-control" rows="5"
								placeholder="分类描述"><?php echo ($artData["acontent"]); ?></textarea>
						</div>
					</div>
	<input type="hidden" name="aid" value="<?php echo ($artData["aid"]); ?>"/>
				</div>
				<!-- /.box-body -->
