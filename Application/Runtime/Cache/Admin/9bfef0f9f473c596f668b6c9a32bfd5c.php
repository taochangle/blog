				...
				<table class="table table-hover">
					<tbody>
						...
						<?php if(is_array($list)): foreach($list as $key=>$k): ?><tr>
							...
							<td><?php echo (date('Y-m-d',$k["ctime"])); ?></td>
							<td><span class="label label-success"><?php echo ($k["corder"]); ?></span></td>
							<td><?php echo ($k["cdesc"]); ?></td>
							<td><a href="#" data-toggle="modal" data-target="#myModal<?php echo ($k["cid"]); ?>">删除</a>| <a href="#" onclick="edit(<?php echo ($k["cid"]); ?>)">编辑</a></td>
						</tr>
						<div class="modal" id="myModal<?php echo ($k["cid"]); ?>">
								...
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4 class="modal-title">
											你确定要删除分类 《<b><?php echo ($k["cneme"]); ?></b>》 吗？
										</h4>
									</div>
									<div class="modal-body">
										<p>分类详情：<?php echo (html_entity_decode($k["cdesc"])); ?></p>
									</div>
									<div class="modal-footer">
										<button type="button" class="btn btn-default pull-left"
											data-dismiss="modal">取消</button>
										<button type="button" class="btn btn-danger"
											onclick="del(<?php echo ($k["cid"]); ?>)">确定删除</button>
									</div>
								</div>
							</div>
